...
namespace AVL_tree
{
        ...
        where T : IComparable
    {
        ...
        /// <summary>
        /// Возвращает перечислитель, который посещает узел в следующем порядке: left child, parent, right child
        /// </summary>
        ...
        /// <summary>
        /// Возвращает перечислитель, который посещает узел в следующем порядке: left child, right child, parent
        /// </summary>
        ...
        /// <summary>
        /// Возвращает перечислитель, который посещает узел в следующем порядке: родитель, слева ребенок, права ребенок
        /// </summary>
        ...
        /// <summary>
        /// Сравнивает два элемента, чтобы определить их позиции в дереве.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает счетчик для симметричного обхода  дерева значений
        /// </summary>
        ...
        /// <summary>
        /// Возвращает счетчик  при Обратном обходе  для дерева значений
        /// </summary>
        ...
        /// <summary>
        /// Возвращает счетчики при прямом обходе  для дерева значений
        /// </summary>
